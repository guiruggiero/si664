"""
Django settings for divelog_online project.
...
APP_NAME = 'divelog.online'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/2.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '-*3tw5rvfqarw-4cnz6=xgz@!^$k2env-q65*ooz#&ad*8&n7a'
...
ROOT_URLCONF = 'divelog_online.urls'
...
WSGI_APPLICATION = 'divelog_online.wsgi.application'
