...
#     bottom_type = models.CharField(max_length=255) # sand, rocks, "infinite", etc.
...
class Site(models.Model):
    ...
    lgn = models.FloatField()
    max_depth = models.FloatField()
    water = models.CharField(max_length=255) # lake, river, ocean, etc.
    salinity = models.CharField(max_length=255) # salty, fresh, etc.
    altitude = models.BooleanField(default=False)
    notes = models.TextField()
    picture = models.BinaryField(null=True, editable=True)
    content_type = models.CharField(max_length=255, null=True, help_text='The MIMEType of the file')
